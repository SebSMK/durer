...
IIPMooViewer.implement({
  ...
  // Use closure for mouseenter and mouseleave events
    ...
    var mousein = function() {
      if (_this.annotationsVisible) {                                                        
            ...
            baloon.animate(
              ...
              function() 
                {
                  $jq(this).animate({backgroundColor: 'rgba(255, 255, 255, 0.1)'}, 1000, "linear");
                  _this.canvas.removeEvent('mouseenter', mousein);              
                }
              );           
    ...
    this.canvas.addEvent('mouseenter', mousein);
  ...
  initAnnotation: function(annotation_item, position) {
    ...
    /*ø*/
    // Add animation on mouseenter / leave events
    if (this.annotationsVisible) {      
    
      var mousein = function() {                                                                                         
              $jq(this).finish().animate(
                {backgroundColor: 'rgba(255, 255, 255, 0.6)',
                borderColor: 'rgba(200, 0, 126, 1)'},               
                200,
                "easeOutExpo",
                function() 
                  {
                    $jq(this).animate({backgroundColor: 'rgba(255, 255, 255, 0.3)',
